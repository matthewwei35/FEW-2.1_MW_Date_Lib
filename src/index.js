...
class D {
  ...
  // --- Date --- //
  get date() {
    return addPadding(this._date.getDate());
  }
  ...
  // --- Hour --- //
  get hour() {
    return addPadding(this._date.getHours());
  }
  ...
  // --- Minute --- //
  get minute() {
    return addPadding(this._date.getMinutes());
  }
  ...
  // --- Second --- //
  get second() {
    return addPadding(this._date.getSeconds());
  }
